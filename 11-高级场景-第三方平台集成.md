---
[⬅️ 上一章：持续集成与知识库同步](10-持续集成与知识库同步.md) | [📑 目录](README.md) | [➡️ 下一章：实践案例与常见问题](12-实践案例与常见问题.md)
---

# 第11章：高级场景：第三方平台集成

> **难度**: ⭐⭐⭐⭐ 高级 | **预计阅读**: 25 分钟 | **前置章节**: [第 6 章](06-自动化命令与脚本集成.md)、[第 7 章](07-飞书集成与消息自动化.md)
...
- [11.1 集成架构总览](#111-集成架构总览)
  - [集成方式对比](#集成方式对比)
  - [架构示意](#架构示意)
  - [通用配置模式](#通用配置模式)
- [11.2 Google Workspace 集成](#112-google-workspace-集成)
  - [安装与认证](#安装与认证)
  - [Gmail 操作](#gmail-操作)
  - [Calendar 操作](#calendar-操作)
  - [Drive 操作](#drive-操作)
  - [Google 服务命令速查](#google-服务命令速查)
  - [实际应用示例](#实际应用示例)
- [11.3 GitHub 集成](#113-github-集成)
  - [配置认证](#配置认证)
  - [常用操作](#常用操作)
  - [GitHub 操作速查](#github-操作速查)
  - [自动化场景](#自动化场景)
- [11.4 飞书与 MCP 集成](#114-飞书与-mcp-集成)
  - [飞书集成](#飞书集成)
  - [自定义 MCP 集成](#自定义-mcp-集成)
  - [MCP Server 管理命令](#mcp-server-管理命令)
  - [集成最佳实践](#集成最佳实践)
- [11.5 集成调试与排障](#115-集成调试与排障)
  - [排查步骤](#排查步骤)
  - [常见错误对照表](#常见错误对照表)
- [实操练习](#实操练习)
- [常见问题 (FAQ)](#常见问题-faq)
...
OpenClaw integrates third-party APIs and tools via skills and plugins, enabling it to connect with various SaaS platforms and execute tasks. It uses webhooks to trigger actions from external systems. OpenClaw can also be accessed programmatically through the Apify API.

### 补充 2

- **OpenClaw custom API integration guide for skills and plugins** (relevance: 100%)
  https://lumadock.com/tutorials/openclaw-custom-api-integration-guide?language=ukranian
  # OpenClaw custom API integration guide for skills and plugins. OpenClaw custom API integration guide for skills and plugins

### 补充 3

- **OpenClaw API Integration Is Live in the Crypto.com App** (relevance: 100%)
  https://crypto.com/us/product-news/openclaw-integration
  # OpenClaw API Integration Is Live in the Crypto.com App. Deploy a personal AI trading agent with Agent Key. OpenClaw API integration is live in the Crypto com A

### 补充 4

- **OpenClaw Assistant API - Apify** (relevance: 100%)
  https://apify.com/agentify/openclaw-assistant/api
  ## OpenClaw Assistant API. You can access the OpenClaw Assistantprogrammatically from your own applications by using the Apify API. # Run the Actor using an HTTP API. # See the full API refer

### 补充 5

- **How to set up OpenClaw and power it with 850+ on-demand SaaS ...** (relevance: 100%)
  https://composio.dev/blog/how-to-setup-openclaw-and-use-saas-apps
...
OpenClaw integrates with various third-party apps and services via APIs, including chat platforms, AI models, productivity tools, and automation systems. Custom API integrations allow connection to REST APIs, CLI tools, and SaaS platforms. The OpenClaw Assistant API enables programmatic access throu

### 补充 2

- **Integrations - OpenClaw** (relevance: 99%)
  https://openclaw.ai/integrations
  50+ integrations with the apps and services you already use. Chat from your phone, control from your desktop, automate everything. ## ⟩ Chat Providers. Message OpenClaw from any chat app — it responds right where you

### 补充 3

- **OpenClaw custom API integration guide for skills and plugins** (relevance: 98%)
...
- **OpenClaw Integrations You Should Be Using for AI Automation** (relevance: 98%)
  https://www.knolli.ai/post/openclaw-integrations
  These integrations allow OpenClaw to connect with chat apps, AI models, productivity tools, and automation systems, turning it into a centralized AI control layer f

### 补充 5

OpenClaw integrates with Notion via the Model Context Protocol (MCP) for control and monitoring. Notion MCP allows AI agents to interact with Notion workspaces. OpenClaw agents can manage projects and tasks directly through Notion.
